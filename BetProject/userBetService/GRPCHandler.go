...
func (h *GRPCHandler) SetBalance(ctx context.Context, info *pb.SetBalanceInfo) (*pb.Response, error) {
	str, err := h.AuthorizationService.SetBalance(int(info.Id), int(info.Money))
	if err != nil {
