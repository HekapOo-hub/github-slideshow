...
type UserServiceClient interface {
	...
	SetBalance(ctx context.Context, in *SetBalanceInfo, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *userServiceClient) SetBalance(ctx context.Context, in *SetBalanceInfo, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/go.micro.srv.user.UserService/SetBalance", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	...
	SetBalance(context.Context, *SetBalanceInfo) (*Response, error)
...
func (UnimplementedUserServiceServer) SetBalance(context.Context, *SetBalanceInfo) (*Response, error) {
...
func _UserService_SetBalance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/go.micro.srv.user.UserService/SetBalance",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).SetBalance(ctx, req.(*SetBalanceInfo))
	}
	return interceptor(ctx, in, info, handler)
}
